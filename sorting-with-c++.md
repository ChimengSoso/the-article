...
for i form 1 to n {        // วนจำนวน n รอบ
  for j form 1 to n-1 {    // ในแต่ละรอบจะทำการดันฟอง(ข้อมูล)ที่เบากว่าให้สูงขึ้น
...
//เวลาจะเรียกใช้ก็ต้องประกาศตัวแปชนิด struct นั้นก่อน
