...
```
อีกตัวอย่างละกัน  สมมติให้ Array a มีข้อมูลดังนี้ [100, 50, 60, 70, 35] output คือลำดับของเลข 1 ถึง n ที่เรียงสับเปลี่ยนกัน ลำดับที่ออกมานี้เป็นการแสดงถึงเลขลำดับ**เดิมของข้อมูล**ที่เรียงจากน้อยไปมาก เช่นในตัวอย่างนี้ เมื่อเรียงเสร็จเราจะได้ข้อมูลดังนี้ [35, 50, 60, 70, 100] ก็แปลงตรงนี้ไปเป็นเลขลำดับเดิมก่อนจะเรียง จะได้ว่า 35 เคยอยู่เลขลำดับที่ 5, 50 เคยอยู่เลขลำดับที่ 2, ุ60 เคยอยู่เลขลำดับที่ 3, 70 เคยอยู่เลขลำดับที่ 4, 100 เคยอยู่เลขลำดับที่ 1 ก็จะได้ output เป็น [5, 2, 3, 4, 1]  
...
```
ซึ่งฟังก์ชันที่มีการนิยามลักษณะการเปรียบเทียบแบบนี้ เราก็พยายามจะสร้างฟังก์ชันที่ไม่ไปเปลี่ยนแปลงค่าของตัวแปรที่เปรียบเทียบใช่ไหมครัช เพราะเราแค่เปรียบเทียบอะ ซึ่งคนในวงการก็เลยมักประกาศฟังก์ชันพวกนี้เป็น constant function และ constant parameter ครับ ก็จะได้โค้ดแบบนี้
```c++
struct Point {
  double x, y;
...
และนี่คือทั้งหมดของการเรียงข้อมูลในภาษาซีพลัสพลัสที่ผมศึกษามาครับ ทั้งนี้การเรียนข้อมูลนั้นก็สำคัญในหลาย ๆ ความหมาย แต่สิ่งที่สำคัญกว่านั้นคือ ข้อมูลที่เรียงแล้วสามารถเอามาใช้ประโยชน์อะไรได้ต่ากหาก เป็นสิ่งที่ควรศึกษาต่อไป
